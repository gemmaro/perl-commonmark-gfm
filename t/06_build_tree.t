...
my $doc         = CommonMark::GFM::Node->new(NODE_DOCUMENT);
my $paragraph   = CommonMark::GFM::Node->new(NODE_PARAGRAPH);
my $emph        = CommonMark::GFM::Node->new(NODE_EMPH);
my $strong      = CommonMark::GFM::Node->new(NODE_STRONG);
